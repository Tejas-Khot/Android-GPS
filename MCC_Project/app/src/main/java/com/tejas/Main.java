...
import com.tejas.library.UserFunctions;
import com.tejas.library.DatabaseHandler;
...
public class Main extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        trackMe = (Button) findViewById(R.id.btTrackMe);
        ...
        trackMe.setOnClickListener(new View.OnClickListener(){
            public void onClick(View arg0){
                ...
                Intent track = new Intent(getApplicationContext(), MyActivity.class);
